...
| --------- | --------------- | ------------ | --------- |
| IDF2 | Vlan4094 | 192.168.0.8 | Port-Channel53 |
...
| Ethernet53 | MLAG_PEER_s1-leaf3_Ethernet53 | *trunk | *2-4094 | *- | *['MLAG'] | 53 |
| Ethernet54 | MLAG_PEER_s1-leaf3_Ethernet54 | *trunk | *2-4094 | *- | *['MLAG'] | 53 |
...
interface Ethernet53
   description MLAG_PEER_s1-leaf3_Ethernet53
   no shutdown
   channel-group 53 mode active
!
interface Ethernet54
   description MLAG_PEER_s1-leaf3_Ethernet54
   no shutdown
   channel-group 53 mode active
```
...
| Port-Channel53 | MLAG_PEER_s1-leaf3_Po53 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel53
   description MLAG_PEER_s1-leaf3_Po53
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  192.168.0.9/31  |  -  |  -  |  -  |  -  |  -  |
